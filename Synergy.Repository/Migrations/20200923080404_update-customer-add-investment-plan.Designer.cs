...
namespace Synergy.Repository.Migrations
{
    ...
    [Migration("20200923080404_update-customer-add-investment-plan")]
    partial class updatecustomeraddinvestmentplan
    {
            ...
            modelBuilder.Entity("Synergy.Repository.Models.ClientRequestLog", b =>
                {
                    ...
                    b.Property<DateTime>("DateLogged")
                        ...
                        .HasDefaultValue(new DateTime(2020, 9, 23, 8, 4, 3, 223, DateTimeKind.Utc).AddTicks(7206));
            ...
            modelBuilder.Entity("Synergy.Repository.Models.ClientResponseLog", b =>
                {
                    ...
                    b.Property<DateTime>("DateLogged")
                        ...
                        .HasColumnName("DateLogged")
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 23, 8, 4, 3, 230, DateTimeKind.Utc).AddTicks(5152));
            ...
            modelBuilder.Entity("Synergy.Repository.Models.CustomerAccount", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 23, 8, 4, 3, 364, DateTimeKind.Utc).AddTicks(1173));
            ...
            modelBuilder.Entity("Synergy.Repository.Models.InvestmentCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasColumnName("CreatedDate")
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 23, 8, 4, 3, 431, DateTimeKind.Utc).AddTicks(1258));
            ...
            modelBuilder.Entity("Synergy.Repository.Models.SynergyInvestment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasColumnName("CreatedDate")
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 9, 23, 8, 4, 3, 435, DateTimeKind.Utc).AddTicks(5381));
